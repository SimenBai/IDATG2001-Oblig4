...
public class MemberArchive {
   ...
   */
  public MemberArchive(List<BonusMember> members) {
    this.members = (ArrayList<BonusMember>) members;
  }
  ...
  /**
   * Populates the member archive with two test users.
   */
  ...
  private int findAvailableNumber() {
    while (true) {
      ...
      if (findMember(memberNo) == null && memberNo > 0) {
        return memberNo;
      }
    }
  }
